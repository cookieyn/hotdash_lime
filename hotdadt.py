...
class HotdashDT:
    ...
    def main(self, args, net_env=None, policy=None, flag = 1):
        viper_flag = True
        ...
        while True:  # serve video forever
            ...
            if flag ==1:
                ...
                bitrate = int(policy.predict(np.array(serialized_state_n).reshape(1, -1))[0])
                rollout.append((state_info_pensieve_n,bitrate,serialized_state_n))
            if end_of_video:
                if args.log:
