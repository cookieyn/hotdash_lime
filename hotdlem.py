...
class Hotdlem:
    ...
    def main(self, args, net_env=None, lemna=None, flag = 1,tt=None):
        viper_flag = True
        ...
        while True:  # serve video forever
            ...
            all_act = tt.predict(states_list)
            ...
            #tmp = lime.predict(np.array(serialized_state).reshape(1, -1))
           ...
           # next_hotspot_bitrate = tmp[0][2]
            ...
            if flag ==1:
                ...
                next_normal_bitrate = int(lemna.predict(np.array(serialized_state_n).reshape(1, -1))[0])
